console.log("Here we solve the excersice 3")
const jokes = [
    ...
    "If an electric train is traveling south at 10 mph and the wind is blowing north at 10 mph, which way does the smoke blow? Fooled you! Electric trains don't blow smoke.",
  ...
  const RandomJoke =()=>{
    ...
    let joke = document.getElementById("Joke_box").innerHTML = `${jokes[i]}`


console.log(` Here is your random picked joke ${joke}`)
  }
  RandomJoke()
